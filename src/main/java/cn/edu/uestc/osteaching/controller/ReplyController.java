...
public class ReplyController {
    ...
    @Transactional
    public void addNewReply(@PathVariable("content") String content,@PathVariable("qid")Integer qid,@PathVariable("sid")Integer sid,@PathVariable("tid")Integer tid,@PathVariable("r_rid")Integer r_rid) {
